    ...
    <body>
        ...
        <table class="table">
            ...
            <tr>
                ...
                <td><span class="text-destaque">Nº DO CAR:</span> <br><?php echo!empty($cooperado['cooperado']['car']) ? $cooperado['cooperado']['car'] : '' ?></td>
                <td><span class="text-destaque">Nº DO DAP:</span> <br><?php echo!empty($cooperado['cooperado']['dap']) ? $cooperado['cooperado']['dap'] : '' ?></td>
            </tr>
            <tr>
