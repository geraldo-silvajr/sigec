...
--
-- Host: 127.0.0.1
-- Tempo de geração: 27/07/2024 às 16:57
...
INSERT INTO `associado` (`cod`, `tipo`, `status`, `apelido`, `nome_completo`, `cpf`, `car`, `dap`, `rg`, `estado_civil`, `nacionalidade`, `genero`, `data_nascimento`, `data_inscricao`, `pai`, `mae`, `conjugue`, `filhos`, `imagem`) VALUES
(1, 'Permissionário', 1, 'João', 'João Garcia Gomes', '111.111.111-11', '', '', '684444 PC/PA', 'Solteiro', 'Brasileiro', 'Masculino', '1995-11-11', '2010-03-05', 'JOSE GOMES', 'LUCIA RODRIGUES', 'LETICIA COSTA', 'LUCAS COSTA GOMES', 'uploads/cooperados/e5493ca0de06b5634a52f7331fb04e21.jpg'),
(2, 'Permissionário', 1, 'sadsad', 'asdasd', '222.222.222-22', '', '', '222222222', 'asdsadas', 'BRASILEIRO', 'Masculino', '1111-11-11', '2022-03-04', 'asdasdsa', 'asdsadsa', 'sadsadsaasd', 'dasdsadas', 'uploads/cooperados/bd6022cd82152d194f765ee65f97c604.jpg'),
(3, 'Permissionário', 1, '11', '111111111111111111', '333.333.333-33', '', '', '111111111', '11111', 'BRASILEIRO', 'Masculino', '0000-00-00', '0000-00-00', '', '', '', '', 'uploads/cooperados/e0f4e4aec5711928ab5a359bf309f13a.jpg');

-- --------------------------------------------------------

--
-- Estrutura para tabela `associado_carteira`
--
...
--
-- Despejando dados para a tabela `associado_carteira`
--
...
--
-- Estrutura para tabela `associado_contato`
--
...
--
-- Despejando dados para a tabela `associado_contato`
--
...
--
-- Estrutura para tabela `associado_endereco`
--
...
--
-- Despejando dados para a tabela `associado_endereco`
--
...
--
-- Estrutura para tabela `associado_historico`
--
...
--
-- Despejando dados para a tabela `associado_historico`
--
...
--
-- Estrutura para tabela `associado_mensalidade`
--
...
--
-- Despejando dados para a tabela `associado_mensalidade`
--
...
--
-- Estrutura para tabela `associado_producao`
--
...
--
-- Despejando dados para a tabela `associado_producao`
--
...
(1, 'APPCJN', '- ASSOCIACAO DOS PRODUTORES RURAIS DA COMUNIDADE JESUS DE NAZARE', '09.524.365/0001-90', 'Rodovia Castanhal Terra Alta - Pa 136, Km 24, S/N Rua Projetada - A Lote 19 Loc Jesus de Nazare, Zona Rural – Castanhal – PA', '68745-000', '(91) 98410-4012', 'appcjn.castanhal@gmail.com', '');
...
(2, 1, '02sadsa', 200, '2024-03-01', '2022-03-03'),
...
(2, 1, 'asdsadas', 50, '2024-03-01', '2022-03-03'),
(3, 1, '50000', 2, '2024-03-15', '2022-03-03');
...
(2, 1, 'teasdas', 1500, '2024-03-01', '2022-03-03'),
(3, 1, '1232132', 100, '2024-03-01', '2022-03-06');
...
(7, 1, 'Joab', 'Torres', 'joab.alencar', 'joabtorres1508@gmail.com', '47cafbff7d1c4463bbe7ba972a2b56e3', 'Administrador', 'M', 3, 1, 'uploads/usuarios/user_masculino.png', '2019-04-11'),
